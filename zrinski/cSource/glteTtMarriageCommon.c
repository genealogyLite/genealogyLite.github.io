/* GenealogyLite "TableTranslation" program for table: [marriageCommon]
   ====================================================================
...
#define LABELS_LINE "wife,husband,pEst,startDate,endDate,note,infoUrl\n"
...
/*    fprintf(stderr, "startDate:[%s]\n", item);  */
      ...
      item = glte_GetCsvItem(NULL);             /* 5-th line item is end date */
...
/*    fprintf(stderr, "note:[%s]\n", item); */
      ...
      item = glte_GetCsvItem(NULL);               /* 6-th line item is URL(s) */
